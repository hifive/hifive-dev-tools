 ...
 */
/***************************************************************************************************
 * h5.ui.container.LoopCarouselController
 **************************************************************************************************/
(function($) {
	// =========================================================================
	//
	 ...
	 *
	 * @class
	 * @name h5.ui.container.LoopCarouselController
	 */
	var loopCarouselController = {
		/**
		 * @memberOf h5.ui.container.LoopCarouselController
		 */
		__name: 'h5.ui.container.LoopCarouselController',
		 ...
		 * 現在繰り返し配置されているものを削除
		 *
		 * @memberOf h5.ui.contaienr.LoopCarouselController
		 */
